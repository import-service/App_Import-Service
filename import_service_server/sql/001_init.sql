...
CREATE TABLE IF NOT EXISTS customs_requests (
  ...
  archive_id BIGINT UNSIGNED NULL DEFAULT NULL,
  archived_by_name VARCHAR(255) NULL DEFAULT NULL,
  archive_location VARCHAR(1000) NULL DEFAULT NULL,
  archive_purged_at DATETIME(3) NULL DEFAULT NULL,
  ...
  KEY idx_cr_archived_at (archived_at),
  KEY idx_cr_archive_purged_at (archive_purged_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
