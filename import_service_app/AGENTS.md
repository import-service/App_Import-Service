...
**`.cursor/rules/plan-before-implement.mdc`** — `alwaysApply: true`.  
Без явного **«делай»** / **«утверждаю»** от пользователя: **не** менять код, **не** commit/push, **не** сборки. Только план, вопросы, read-only.
