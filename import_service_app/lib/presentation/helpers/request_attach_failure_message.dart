...
String? resolveRequestFileSizeLimitMessage(
  String rawMessage,
  JsonStringsService strings,
) {
  if (rawMessage == requestFileSizeLimitPhotoKey ||
      rawMessage == requestFileSizeLimitVideoKey) {
    return strings.text(rawMessage);
  }
  return null;
}
