/// Значения профиля демо-пользователя (как будто из ответа API `/me` для demo tenant).
abstract final class DemoProfileSnapshot {
  static const String companyName = 'ООО Демо Импорт';
